#!/usr/bin/env node
/**
 * Fetch coduri reducere Trendyol de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/trendyol.com
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/trendyol.com";
const STORE_NAME  = "Trendyol";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-trendyol)" }
  });
