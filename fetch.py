#!/usr/bin/env python3
"""
Fetch coduri de reducere Trendyol de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/trendyol.com
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/trendyol.com"
STORE_NAME = "Trendyol"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Trendyol de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-trendyol)"
    }
    try:
